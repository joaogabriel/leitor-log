				...
				new Thread() {
					public void run() {
						try {
							...
							InputStream in = new FileInputStream("D:\\Temp\\TesteLeituraLog\\server.log");
							ProgressMonitorInputStream pm = new ProgressMonitorInputStream(f, "Reading the big file", in);
							...
							pm.close(); // needs better error handling, of
										// course...
						} catch (Exception ex) {
							ex.printStackTrace();
						}
